...
SELECT 
        ...
        O.OFFICE,
        SUM(ORDS.QTY) AS TOTAL_QTY,
        MAX(SUM(ORDS.QTY)) OVER (PARTITION BY O.OFFICE) AS MaxTotalQty,
   100 - 100 * SUM(ORDS.QTY) / MAX(SUM(ORDS.QTY)) OVER (PARTITION BY O.OFFICE) 
    FROM 
        SALESREPS SR
    JOIN 
        ORDERS ORDS ON SR.EMPL_NUM = ORDS.REP
...
SELECT o.CUST, o.ORDER_DATE, o.AMOUNT,
       LAG(o.AMOUNT, 3) OVER (PARTITION BY o.CUST ORDER BY o.ORDER_DATE) AS AMOUNT_PREV_YEAR,
       100.0 * (o.AMOUNT - LAG(o.AMOUNT, 3) OVER (PARTITION BY o.CUST ORDER BY o.ORDER_DATE)) / LAG(o.AMOUNT, 3) OVER (PARTITION BY o.CUST ORDER BY o.ORDER_DATE) AS PERCENT_DIFF
FROM ORDERS o
WHERE o.ORDER_DATE BETWEEN '2007-10-01' AND '2007-12-31'
   OR o.ORDER_DATE BETWEEN '2008-01-01' AND '2008-03-31'
ORDER BY o.CUST, o.ORDER_DATE DESC;